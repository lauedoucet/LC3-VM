/*
 * Basically each instruction is represented as a bit in a 16-bit string,
 * their position in the 16-bit string depends on their declaration below.
 * Each repeated operation has a 16-bit string (represented as HEX below)
 * which indicates if they are used in the instr indicated by opbit.
 * 
